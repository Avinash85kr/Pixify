      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-2xl font-bold text-gradient">Pixify</span>
            </div>
            <p className="text-secondary mb-6 max-w-md leading-relaxed">
             Turn imagination into reality with AI-powered image creation. Design, explore, and inspire.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted text-sm">
            © 2025 Pixify. All rights reserved.
          </p>
