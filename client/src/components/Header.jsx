  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        >
          <span className="text-gradient">Bring Concepts to Life With AI-Powered Art</span>
        ...
        >
          Bring your imagination to life with AI-crafted visuals. Create stunning images in seconds from simple words.
        </motion.p>
